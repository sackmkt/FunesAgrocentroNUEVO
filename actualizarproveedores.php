<?php
    ...
    $id=$_GET["id"];
    $consulta="SELECT * FROM registroproveedores WHERE id_proveedor='$id'";
?>
<!DOCTYPE html>
<html lang="es-ES">
...
<body>
	<header>
		...
		<div class="options">
			...
			<div id='user'>
				...
				<div class="userMenu">
				    <a href="consultaregistroproveedores.php">Volver</a>
	...
	<main>
		...
		<form class="contenedor" action="procesaractualizarproveedores.php" method="POST">
           ...
           <input type="hidden" class="itemtabla" value="<?php echo $row["id_proveedor"];?>" name="id">
           <input type="text" class="itemtabla" value="<?php echo $row["razonsocial"];?>" name="razonsocial">
           <input type="text" class="itemtabla" value="<?php echo $row["cuit"];?>" name="cuit">
